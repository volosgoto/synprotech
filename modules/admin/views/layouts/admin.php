...
<div class="w3-bar w3-top w3-blue w3-large" style="z-index:4">
    <a href="<?php Url::home()?>" class="w3-bar-item w3-button w3-hide-small w3-hover-blue-gray"><b>Admin panel main page</b></a>
    <a href="<?= Url::toRoute(['/site/index']);?>" class="w3-bar-item w3-button w3-hide-small w3-hover-blue-gray"><b>Home</b></a>
...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
    ...
    <div class="w3-bar-block">
        ...
        <a href="<?= Url::toRoute('/reference/index');?>" class="w3-bar-item w3-button w3-padding w3-blue"><i class="fa fa-users fa-fw"></i>  Overview</a>
